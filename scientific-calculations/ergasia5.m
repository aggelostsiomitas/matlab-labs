...
% Temperature matrix for 2-flip simulation
T_2flip = zeros(N, nt+1);  
...
t1_2flip = tic; %time for second simulation starts
for i = 2:nt+1
...
%print  the speed difference percentage
